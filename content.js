...
//for (var i = 0, l = buttons.length; i < l; i++) {
  ...
  //if(buttons[i].innerText === "") {
   // buttons[i].setAttribute("prevkqtext", buttons[i].innerHTML)
    //buttons[i].setAttribute("onmouseover", "this.firstChild.innerText = \"Wait!! Killer Queen has already touched that button!!\"")
    //buttons[i].setAttribute("onmouseout", "this.innerHTML = \"" + buttons[i].getAttribute("prevkqtext") + "\"")
  //} else {
    //buttons[i].setAttribute("prevkqtext", buttons[i].innerText)
    //buttons[i].setAttribute("onmouseover", "this.innerText = \"Wait!! Killer Queen has already touched that button!!\"")
...
//for (var i = 0, l = Math.floor(links.length * PERCENT); i < l; i++) {
 ...
 //   links[i].setAttribute("onmouseout", "this.innerText = \"" + links[i].getAttribute("prevkqtext") + "\"")
  //}
}
...
(function() {
  ...
  Bomb = (function() {
    ...
    Bomb.prototype.drop = function() {
      ...
      return setTimeout(this.countDown, 0);
    };
